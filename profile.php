                        ...
                        <form method="POST" enctype="multipart/form-data" id="basic-info-form">
                            <div class="row mb-4">
                                <label for="u_avatar" class="col-sm-3 col-form-label form-label">
                                    Profile photo                                </label>
                                <div class="col-sm-9">
                                    <label class="avatar avatar-xxl avatar-circle avatar-uploader border shadow-sm p-1" for="u_avatar">
                                        <img id="u_avatar_preview" class="avatar-img bg-light" src="assets/svg/avatar.svg" style="object-fit: contain;">
                                        <input type="file" name="u_avatar" class="js-file-attach avatar-uploader-input" id="u_avatar" data-hs-file-attach-options='{
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" value="demo@nursery.com" disabled>
                                </div>
                            </div>
                            <div class="row mb-4">
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="submit" name="change_avatar" form="basic-info-form" class="btn btn-sm btn-primary">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div id="passwordSection" class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" class="js-validate needs-validation" novalidate id="password-form">
                            <div class="row mb-4">
                                <label for="old_password" class="col-sm-3 col-form-label form-label">Old password</label>
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" name="u_password" id="old_password" required minlength="8" autocomplete="off">
                                    <label id="old_password-error" class="error invalid-feedback" for="old_password"></label>
                                </div>
                            </div>
                            <div class="row mb-4">
                                <label for="new_password" class="col-sm-3 col-form-label form-label">New password</label>
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" name="password" id="new_password" required minlength="8" autocomplete="off">
                                    <label id="new_password-error" class="error invalid-feedback" for="new_password"></label>
                                </div>
                            </div>
                            <div class="row mb-4">
                                <label for="confirm_password" class="col-sm-3 col-form-label form-label">Confirm new password</label>
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" name="cpassword" id="confirm_password" required minlength="8" autocomplete="off">
                                    <label id="confirm_password-error" class="error invalid-feedback" for="confirm_password"></label>
                                </div>
                            </div>
                            <div class="d-flex justify-content-end">
                                <button type="submit" name="change_password" class="btn btn-sm btn-primary">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
